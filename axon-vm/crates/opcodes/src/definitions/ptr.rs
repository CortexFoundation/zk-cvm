...
pub const MAX_OFFSET_FOR_ADD_SUB: U256 = U256::from_limbs([1u64 << 32, 0, 0, 0]);

impl OpcodeVariantProps for PtrOpcode {
    fn all_variants() -> Vec<Self> {
        vec![PtrOpcode::Add, PtrOpcode::Sub, PtrOpcode::Pack, PtrOpcode::Shrink]
    }
...
impl OpcodeProps for PtrOpcode {
    ...
    fn input_operands(&self, _version: ISAVersion) -> Vec<Operand> {
        vec![Operand::Full(ImmMemHandlerFlags::UseRegOnly), Operand::RegOnly]
    }
