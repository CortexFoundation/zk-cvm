...
pub fn erase_fat_pointer_metadata(ptr: &mut U256) {
    ...
    unsafe {
        ptr.as_limbs_mut()[0] &= 0x00000000_ffffffffu64;
        ptr.as_limbs_mut()[1] &= 0xffffffff_00000000u64;
    }
}

pub(crate) fn u64_to_address(num: u64) -> Address {
    Address::left_padding_from(&num.to_be_bytes())
}
