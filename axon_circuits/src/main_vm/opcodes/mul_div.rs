...
pub(crate) fn apply_mul_div<F: SmallField, CS: ConstraintSystem<F>>(
    ...
    const MUL_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Mul(zkvm_opcodes::MulOpcode);
    const DIV_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Div(zkvm_opcodes::DivOpcode);
