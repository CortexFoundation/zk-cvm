...
pub(crate) fn apply_ptr<F: SmallField, CS: ConstraintSystem<F>>(
    ...
    const PTR_ADD_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Ptr(zkvm_opcodes::PtrOpcode::Add);
    const PTR_SUB_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Ptr(zkvm_opcodes::PtrOpcode::Sub);
    const PTR_PACK_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Ptr(zkvm_opcodes::PtrOpcode::Pack);
    const PTR_SHRINK_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Ptr(zkvm_opcodes::PtrOpcode::Shrink);
