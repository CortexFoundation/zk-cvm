    ...
    [(); <ExecutionContextRecord<F> as CSAllocatableExt<F>>::INTERNAL_STRUCT_LEN]:,
{
    ...
    let is_ret_ok = common_opcode_state
        .decoded_opcode
        .properties_bits
        .boolean_for_variant(zkvm_opcodes::Opcode::Ret(
            zkvm_opcodes::RetOpcode::Ok,
        ));
    ...
    let is_ret_revert = common_opcode_state
        ...
        .properties_bits
        .boolean_for_variant(zkvm_opcodes::Opcode::Ret(
            zkvm_opcodes::RetOpcode::Revert,
        ));
    let is_ret_panic = common_opcode_state
        .decoded_opcode
        .properties_bits
        .boolean_for_variant(zkvm_opcodes::Opcode::Ret(
            zkvm_opcodes::RetOpcode::Panic,
        ));
    ...
    let is_to_label = common_opcode_state
        .decoded_opcode
        .properties_bits
        .flag_booleans[zkvm_opcodes::ret::RET_TO_LABEL_BIT_IDX];
