    ...
    fn execute_precompile<M: Memory>(
        ...
        for round in 0..num_rounds {
            ...
            for idx in 0..MEMORY_READS_PER_CYCLE {
                ...
                let should_read = !paddings_round && enough_buffer_space;

                let bytes_to_fill = if should_read { meaningful_bytes_in_query } else { 0 };
                ...
                if should_read {
                    ...
                    bytes32_buffer = data.to_be_bytes();
                }
...
pub fn keccak256_rounds_function<M: Memory, const B: bool>(
    ...
    memory: &mut M,
) -> Option<(Vec<MemoryQuery>, Vec<MemoryQuery>, Vec<Keccak256RoundWitness>)> {
