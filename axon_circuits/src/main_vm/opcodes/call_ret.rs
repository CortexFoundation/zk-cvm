    ...
    [(); <DecommitQuery<F> as CSAllocatableExt<F>>::INTERNAL_STRUCT_LEN]:,
{
    ...
    const NEAR_CALL_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::NearCall(zkvm_opcodes::NearCallOpcode);
    const RET_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Ret(zkvm_opcodes::RetOpcode::Ok);
