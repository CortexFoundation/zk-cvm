...
pub(crate) fn apply_context<F: SmallField, CS: ConstraintSystem<F>>(
    ...
    const GET_THIS_ADDRESS_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::This,
    );
    const GET_CALLER_ADDRESS_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::Caller,
    );
    const GET_CODE_ADDRESS_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::CodeAddress,
    );
    const GET_META_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::Meta,
    );
    const GET_ERGS_LEFT_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::ErgsLeft,
    );
    const GET_SP_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::Sp,
    );
    const GET_CONTEXT_U128_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::GetContextU128,
    );
    // attempt to execute in non-kernel mode for this opcode would be caught before
    const SET_CONTEXT_U128_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::SetContextU128,
    );
    const SET_PUBDATA_ERGS_OPCODE: zkvm_opcodes::Opcode = zkvm_opcodes::Opcode::Context(
        zkvm_opcodes::definitions::context::ContextOpcode::SetErgsPerPubdataByte,
    );
    const INCREMENT_TX_NUMBER_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Context(
            zkvm_opcodes::definitions::context::ContextOpcode::IncrementTxNumber,
        );
