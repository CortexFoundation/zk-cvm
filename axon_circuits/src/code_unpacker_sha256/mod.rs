...
use crate::{
    base_structures::{
        decommit_query::*, memory_query::*, vm_state::FULL_SPONGE_QUEUE_STATE_WIDTH,
    },
    ethereum_types::U256,
    ...
    [(); UInt256::<F>::INTERNAL_STRUCT_LEN + 1]:,
{
    ...
    use zkvm_opcodes::VersionedHashDef;
    let versioned_hash_top_16_bits =
        (zkvm_opcodes::versioned_hash::ContractCodeSha256::VERSION_BYTE as u16) << 8;
...
mod tests {
    ...
    use boojum::{
        ...
        cs::{
            implementations::reference_cs::CSDevelopmentAssembly,
    ...
    use super::*;
    use crate::{
        base_structures::{decommit_query, vm_state::FULL_SPONGE_QUEUE_STATE_WIDTH},
