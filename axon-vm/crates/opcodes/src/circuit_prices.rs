...
// The following circuits are single-instance and so the provided prices are just minimal prices to
// preserve DDoS safety
...
// Equals to max(INITIAL_WRITES_PUBDATA_HASHER_MIN_COST_IN_ERGS,
