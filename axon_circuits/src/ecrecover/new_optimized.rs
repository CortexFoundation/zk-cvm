...
use boojum::{
    ...
    gadgets::{
        ...
        boolean::Boolean,
        curves::{sw_projective::SWProjectivePoint, zeroable_affine::ZeroableAffinePoint},
        keccak256::keccak256,
        non_native_field::{implementations::*, traits::NonNativeField},
        num::Num,
        queue::{CircuitQueueWitness, QueueState},
        tables::{And8Table, ByteSplitTable},
        traits::{
    ...
    pairing::{ff::PrimeField, CurveAffine, GenericCurveAffine, GenericCurveProjective},
    sha3::digest::typenum::private::IsGreaterPrivate,
};
use cs_derive::*;
...
use crate::{
    ...
    ecrecover::secp256k1::fixed_base_mul_table::FixedBaseMulTable,
    ethereum_types::U256,
    ...
    [(); <UInt256<F> as CSAllocatableExt<F>>::INTERNAL_STRUCT_LEN + 1]:,
{
    ...
    let precompile_address = UInt160::allocated_constant(
        cs,
        *zkvm_opcodes::system_params::ECRECOVER_INNER_FUNCTION_PRECOMPILE_FORMAL_ADDRESS,
    );
...
mod test {
    ...
    use boojum::{
        ...
        gadgets::{
            non_native_field::implementations::implementation_u16::FFProxyValue,
            traits::allocatable::CSAllocatable,
        },
        pairing::ff::{Field, PrimeField, SqrtField},
        worker::Worker,
    };
