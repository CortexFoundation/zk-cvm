...
pub const MAX_OFFSET_TO_DEREF: U256 =
    U256::from_limbs([MAX_OFFSET_TO_DEREF_LOW_U32 as u64, 0, 0, 0]);
            ...
            ISAVersion(0) => {
                ...
                match self {
                    UMAOpcode::HeapWrite | UMAOpcode::AuxHeapWrite => {
                        vec![Operand::RegOrImm(RegOrImmFlags::UseRegOnly), Operand::RegOnly]
                    }
