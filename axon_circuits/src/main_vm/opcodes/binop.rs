...
pub(crate) fn apply_binop<F: SmallField, CS: ConstraintSystem<F>>(
    ...
    const AND_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Binop(zkvm_opcodes::definitions::binop::BinopOpcode::And);
    const OR_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Binop(zkvm_opcodes::definitions::binop::BinopOpcode::Or);
    const XOR_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Binop(zkvm_opcodes::definitions::binop::BinopOpcode::Xor);
