...
pub(crate) fn apply_shifts<F: SmallField, CS: ConstraintSystem<F>>(
    ...
    const SHL_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Shift(zkvm_opcodes::definitions::shift::ShiftOpcode::Shl);
    const ROL_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Shift(zkvm_opcodes::definitions::shift::ShiftOpcode::Rol);
    const SHR_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Shift(zkvm_opcodes::definitions::shift::ShiftOpcode::Shr);
    const ROR_OPCODE: zkvm_opcodes::Opcode =
        zkvm_opcodes::Opcode::Shift(zkvm_opcodes::definitions::shift::ShiftOpcode::Ror);
